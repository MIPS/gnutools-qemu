...
public:
    ...
    nanoMIPSdisassembler(img::address pc, TABLE_ATTRIBUTE_TYPE requested_instruction_catagories) 
        : m_pc(pc)
        , m_requested_instruction_catagories(requested_instruction_catagories)
    {
    }
    
    int Disassemble(const uint16 * data, std::string &dis, TABLE_ENTRY_TYPE & type);    
...
private:
    ...
    int Disassemble(const uint16 * data, std::string &dis, TABLE_ENTRY_TYPE & type, const Pool *table, int table_size);    
