...
/* GIC_VPE_MASK Masks */
#define GIC_VPE_MASK_WD_SHF         0
#define GIC_VPE_MASK_WD_MSK         (MSK(1) << GIC_VPE_MASK_WD_SHF)
#define GIC_VPE_MASK_CMP_SHF        1
#define GIC_VPE_MASK_CMP_MSK        (MSK(1) << GIC_VPE_MASK_CMP_SHF)
#define GIC_VPE_MASK_TIMER_SHF      2
#define GIC_VPE_MASK_TIMER_MSK      (MSK(1) << GIC_VPE_MASK_TIMER_SHF)
#define GIC_VPE_MASK_PERFCNT_SHF    3
#define GIC_VPE_MASK_PERFCNT_MSK    (MSK(1) << GIC_VPE_MASK_PERFCNT_SHF)
#define GIC_VPE_MASK_SWINT0_SHF     4
#define GIC_VPE_MASK_SWINT0_MSK     (MSK(1) << GIC_VPE_MASK_SWINT0_SHF)
#define GIC_VPE_MASK_SWINT1_SHF     5
#define GIC_VPE_MASK_SWINT1_MSK     (MSK(1) << GIC_VPE_MASK_SWINT1_SHF)
#define GIC_VPE_MASK_FDC_SHF        6
#define GIC_VPE_MASK_FDC_MSK        (MSK(1) << GIC_VPE_MASK_FDC_SHF)
#define GIC_VPE_SET_RESET_MSK       (MSK(7) << GIC_VPE_MASK_WD_SHF)
