...
static mips_def_t mips_defs[] =
{
    ...
    },
    {
        ...
        .SYNCI_Step = 32,
        .CCRes = 2,
        .CP0_Status_rw_bitmask = 0x3378FF1F,
        .CP1_fcr0 = (1 << FCR0_Has2008 ) |
                    (1 << FCR0_L) | (1 << FCR0_W) | (1 << FCR0_D) |
                    (1 << FCR0_S) | (0x93 << FCR0_PRID),
        .SEGBITS = 32,
        .PABITS = 32,
    ...
    },
    {
        ...
        .CP1_fcr0 = (1 << FCR0_UFRP) | (1 << FCR0_Has2008 ) | (1 << FCR0_F64) |
                    (1 << FCR0_L) | (1 << FCR0_W) | (1 << FCR0_D) |
                    (1 << FCR0_S) | (0x93 << FCR0_PRID) | (1 << FCR0_FREP),
        .SEGBITS = 32,
        .PABITS = 32,
        .insn_flags = CPU_MIPS32R5 | ASE_MIPS16 | ASE_DSP | ASE_DSPR2 | ASE_MSA,
        .mmu_type = MMU_TYPE_R4000,
    ...
    {
        /* A generic CPU providing MIPS32 Release 5 and XPA features.
           FIXME: Eventually this should be replaced by a real CPU model. */
        .name = "mips32r5-generic-xpa",
        .CP0_PRid = 0x00019700,
        .CP0_Config0 = MIPS_CONFIG0 | (0x1 << CP0C0_AR) |
                    (MMU_TYPE_R4000 << CP0C0_MT),
        .CP0_Config1 = MIPS_CONFIG1 | (1 << CP0C1_FP) | (15 << CP0C1_MMU) |
    ...
    const char *filename)
{
    ...
    fp = fopen(filename, "r");
    if (!fp) {
        cpu_abort(CPU(cpu), "Cannot open config file '%s'\n", filename);
    }
    ...
    while (fgets(line, LINE_MAX, fp) != NULL) {
        ...
        if (res != 3) {
            cpu_abort(CPU(cpu), "Bad line in configfile %s: %s\n", filename, line);
        }
        ...
        cpu_abort(CPU(cpu), "Unknown override option %s\n", name);
    }
}
