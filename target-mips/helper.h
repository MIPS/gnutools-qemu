...
#else
DEF_HELPER_1(mfhc0_entrylo0, tl, env)
DEF_HELPER_1(mfhc0_entrylo1, tl, env)
DEF_HELPER_1(mfhc0_taglo, tl, env)
DEF_HELPER_1(mfhc0_lladdr, tl, env)
DEF_HELPER_0(mfhc0_maar, tl)

DEF_HELPER_2(mthc0_entrylo0, void, env, tl)
DEF_HELPER_2(mthc0_entrylo1, void, env, tl)
DEF_HELPER_2(mthc0_taglo, void, env, tl)
DEF_HELPER_2(mthc0_lladdr, void, env, tl)
...
/* MSA */
DEF_HELPER_4(load_wr_elem_target_s64, tl, env, s32, s32, s32)
DEF_HELPER_4(load_wr_elem_s64, s64, env, s32, s32, s32)

DEF_HELPER_4(load_wr_elem_target_i64, tl, env, s32, s32, s32)
DEF_HELPER_4(load_wr_elem_i64, i64, env, s32, s32, s32)

DEF_HELPER_5(store_wr_elem_target, void, env, tl, s32, s32, s32)
DEF_HELPER_5(store_wr_elem, void, env, i64, s32, s32, s32)
